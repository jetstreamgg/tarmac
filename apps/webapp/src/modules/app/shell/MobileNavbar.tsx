  ...
  return (
    ...
    <motion.nav
      ...
      className={cn(
        ...
        // reserves the scrollbar's column on every route and through a scroll
        // lock (scrollbar-gutter in globals.css), so the page never gives up
        // width on the right that the pill would have to back off from.
