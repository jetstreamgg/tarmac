      ...
      {shouldShowFloating && (
        <>
          ...
          <motion.div
            ...
            className="bg-brandDark fixed bottom-[84px] right-6 z-[45] h-[calc(100vh-250px)] max-h-[1080px] w-[440px] overflow-hidden rounded-3xl border shadow-2xl xl:w-[465px]"
          >
