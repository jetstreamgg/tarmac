...
export function usePendleRedeemModal(market: PendleMarketConfig) {
  ...
  // The Safe iframe can't switch networks from the dapp (APP-486) — the cards
  // disable Claim and explain instead of offering a click that always fails.
  const switchBlocked = !onPendleChain && isSafeApp;
