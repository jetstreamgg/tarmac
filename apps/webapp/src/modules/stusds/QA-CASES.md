...
| A-4 | Provider notice in supply modal                      | **pass*** | `StUsdsProviderNotice` component tests; e2e omits notice when native route is silent |
...
| 3   | supply validation              | `stusds-supply-flow`     | B-1, A-4*   | Modal validation; notice in component tests when non-native |
