...
export function SealEngine() {
  return (
    <Layout>
      <main
        className="bg-container group mx-4 mt-20 mb-10 flex h-auto max-w-[680px] min-w-[375px] flex-col gap-3 overflow-x-hidden overflow-y-auto rounded-t-3xl border bg-blend-overlay backdrop-blur-[50px] md:scrollbar-thin md:rounded-3xl"
