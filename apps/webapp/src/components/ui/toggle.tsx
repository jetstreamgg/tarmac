...
const toggleVariants = cva(
  'inline-flex flex-col items-center rounded-xl justify-center font-circle text-sm text-textSecondary font-medium ring-offset-pageBackground transition-[background-color,color] after:bg-muted disabled:pointer-events-none disabled:opacity-50 overflow-hidden',
  {
    variants: {
      variant: {
        default:
