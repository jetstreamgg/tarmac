...
describe('StakeModuleWidget tests', () => {
  ...
  it('shows the open position flow when urnIndex is 0', async () => {
    ...
    const useCurrentUrnIndexMock = vi.spyOn(await import('@/hooks'), 'useCurrentUrnIndex');
  ...
  it('handles approval flow correctly', async () => {
    ...
    const useStakeSkyAllowanceMock = vi.spyOn(await import('@/hooks'), 'useStakeSkyAllowance');
    ...
    const useStakeSkyApproveMock = vi.spyOn(await import('@/hooks'), 'useStakeSkyApprove');
  ...
  it('handles transaction status changes correctly', async () => {
    ...
    const useStakeMulticallMock = vi.spyOn(await import('@/hooks'), 'useStakeMulticall');
  ...
  it('handles URN change callback correctly', async () => {
    ...
    const useStakeUrnAddressMock = vi.spyOn(await import('@/hooks'), 'useStakeUrnAddress');
