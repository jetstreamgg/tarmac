 ...
 * endpoints:
 *   - /v5/.../transactions?type=TRADES → BUY_PT / SELL_PT (passed through from
 *     the v5 schema)
 *   - /v1/pnl/transactions filtered to `redeemPy` (wire value) → REDEEM_PY
 *     (canonicalized at the transport layer in usePendleMarketHistory)
 *
