...
export const RewardsStatsCard = ({
  ...
  return (
    <RewardsStatsCardCore
      ...
      className="from-card to-card hover:from-primary-start/100 hover:to-primary-end/100 active:from-primary-start/100 active:to-primary-end/100 bg-transparent bg-radial-(--gradient-position) transition-[background-color,background-image,opacity]"
      content={
        <VStack gap={0}>
